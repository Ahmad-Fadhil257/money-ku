<template>
  <footer class="bg-indigo-950 text-white mt-20">
    <div class="max-w-6xl mx-auto px-6 py-12 grid gap-8 md:grid-cols-4">
      <div>
        <div class="text-2xl font-extrabold tracking-tight">Duit-Ku</div>
      ...
      <div>
        ...
        <ul class="space-y-2 text-sm opacity-90">
          <li><a class="link link-hover">0838-3906-2318</a></li>
          <li><a class="link link-hover">2zi009adf@gmail.com</a></li>
        </ul>
      </div>
    </div>
    <div class="border-t border-base-100/10">
      <div class="max-w-6xl mx-auto px-6 py-6 text-center text-sm opacity-80">
        © 2025 Duit-Ku. All rights reserved.
      </div>
    </div>
  </footer>
</template>
