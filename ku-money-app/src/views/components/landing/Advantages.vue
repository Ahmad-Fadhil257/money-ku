  ...
  <section class="py-20 bg-gray-50" id="advantages">
    <div class="max-w-6xl mx-auto px-6">
      <div class="text-center mb-12">
        <h2 class="text-3xl md:text-4xl font-extrabold text-slate-800 mb-4">Kenapa Duit-Ku?</h2>
        <p class="text-gray-600 max-w-2xl mx-auto">
          Kelola uang jadi sederhana. Duit-Ku menyatukan pencatatan, anggaran, dan insight dalam
